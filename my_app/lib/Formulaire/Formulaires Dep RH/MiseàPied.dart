...
class MisePied extends StatelessWidget {
  const MisePied({Key? key}) : super(key: key);
                      ...
                      children: <TextSpan>[
                        TextSpan(
                          children: <InlineSpan>[
                            ...
                            const WidgetSpan(
                                child: Text(
                              "nous avons eu à regretter de votre part ",
                              style: TextStyle(
                                  fontFamily: 'Poppins',
                                  fontStyle: FontStyle.normal,
                                  fontWeight: FontWeight.bold,
                            ...
                            const WidgetSpan(
                                child: Text(
                              " et les sanctions pour retard déjà appliquées ( ",
                              style: TextStyle(
                                  fontFamily: 'Poppins',
                                  fontStyle: FontStyle.normal,
                                  fontWeight: FontWeight.bold,
